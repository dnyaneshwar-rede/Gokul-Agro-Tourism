...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You.",
    url: "https://www.gokulagrotourism.co.in/privacy",
    type: "website",
    locale: "en_IN",
  ...
  return (
    <>
      <div className="max-w-prose m-auto space-y-3">
        ...
        <h2 className="font-bold text-lg">Interpretation and Definitions</h2>
        <h3 className="font-bold text-sm">Interpretation</h3>
        <p>
        ...
        <ul className="space-y-3">
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Gokul Agro Tourism.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Gokul Agro Tourism, accessible
              from{" "}
              <a
                href="https://www.gokulagrotourism.co.in/"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://www.gokulagrotourism.co.in/
              </a>
            </p>
          </li>
          <li>
        ...
        <h3 className="font-bold text-sm">Use of Your Personal Data</h3>
        ...
        <h3 className="font-bold text-sm">Transfer of Your Personal Data</h3>
        <p>
        ...
        <h3 className="font-bold text-sm">Delete Your Personal Data</h3>
        <p>
        ...
        <h3 className="font-bold text-sm">Disclosure of Your Personal Data</h3>
        <h4 className="font-bold text-sm">Business Transactions</h4>
        <p>
        ...
        <h4 className="font-bold text-sm">Law enforcement</h4>
        <p>
          Under certain circumstances, the Company may be required to disclose
          Your Personal Data if required to do so by law or in response to valid
          requests by public authorities (e.g. a court or a government agency).
        </p>
        <h4 className="font-bold text-sm">Other legal requirements</h4>
        <p>
        ...
        <h3 className="font-bold text-sm">Security of Your Personal Data</h3>
        <p>
        ...
        <h2 className="font-bold text-lg">Childrens Privacy</h2>
        <p>
        ...
        <h2 className="font-bold text-sm">Links to Other Websites</h2>
        <p>
        ...
        <ol>
          <li>By phone number: 9423121863</li>
        </ol>
      </div>
    </>
  );
