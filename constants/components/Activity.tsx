...
const Activity = () => {
  return (
    <section className="py-10 px-3 my-6 max-w-2xl mx-auto border rounded-lg flex flex-col gap-6">
      <section className=" flex flex-col justify-start items-start gap-3">
        ...
        <ul className="max-w-md space-y-1 text-blue-500 list-disc list-inside dark:text-green-500">
          <h4 className="text-2xl font-bold dark:text-white">For the Kids:</h4>
          <li>
        ...
        <ul className="max-w-md space-y-1 text-blue-500 list-disc list-inside dark:text-green-500">
          <h4 className="text-2xl font-bold dark:text-white">Accommodation:</h4>
        ...
        <ul className="max-w-md space-y-1 text-blue-500 list-disc list-inside dark:text-green-500">
          ...
          <li>
            Hall Available for Domestic/Family and Business Meetings and Events
          </li>
        </ul>
